...
myMatrix8 = np.dot(myMatrix, myMatrix7)
myMatrix9 = np.dot(myMatrix, myMatrix8)
myMatrix10 = np.dot(myMatrix, myMatrix9)

myExpandedMatrix = myMatrix + myMatrix2 + myMatrix3 + myMatrix4 + myMatrix5 + myMatrix6 + myMatrix7 + myMatrix8 + myMatrix9 + myMatrix10;
